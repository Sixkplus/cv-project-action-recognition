...
flags.DEFINE_string('continue_training','my_model/coviar/all_net.chkp-40000', 'continue_step')
flags.DEFINE_string('saved_model_path','new_pretrained', 'saved pretrained model')
